...
class SerieModel {
  ...
  SerieModel.fromJson(Map<String, dynamic> json)
      : id_serie = int.parse(json["id_serie"]),
        serie = json["serie"],
        ejercicios =(json["ejercicios"] as List).map((i)=>Rutina_Ejercicio_Model.fromJson2(i)).toList();
  ...
  SerieModel.fromJson3(Map<String, dynamic> json)
      : id_serie = int.parse(json["id_serie"]),
        serie = json["serie"],
        ejercicios =(json["ejercicios"] as List).map((i)=>Rutina_Ejercicio_Model.fromJson3(i)).toList();
  Map toJson() => {
    "id_serie": id_serie,
    "id_rutina": id_rutina,
    "serie": serie
