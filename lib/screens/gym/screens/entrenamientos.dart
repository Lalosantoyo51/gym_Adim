    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(onPressed: ()async{
          await ent.getUser();
          await Get.offAll(HomeAdmin(user: ent.user!,));
              ...
              children: [
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                                onPressed: () {
                                  ent.advertencia(context,
                                      ent.entrenamientos[index].id_ent!);
                                },
                                icon: const Icon(
                                  Icons.cancel,
                                  color: Colors.red,
                ...
                Padding(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      Get.to(Usuarios(provine: "entrenamiento",
                        id_ent:  ent.entrenamientos[index].id_ent,entrenamientos: ent.entrenamientos,));
                    },
                    child: Stack(
